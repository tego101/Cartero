...
func BreadCrumbs(props BreadCrumbsProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for i, link := range props.Links {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/bread-crumb.templ`, Line: 22, Col: 26}
			}
			...
			if link.Link != "" {
				...
				if link.Name != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/bread-crumb.templ`, Line: 42, Col: 25}
					}
				...
				if link.Name != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/bread-crumb.templ`, Line: 57, Col: 25}
					}
			...
			if i != len(props.Links)-1 {
				...
				if props.Separator != "" {
					templ_7745c5c3_Err = templ.Raw(props.Separator).Render(ctx, templ_7745c5c3_Buffer)
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
